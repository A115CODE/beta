// DataBase
const urlSBsolver = 'https://xqkozqxrvoypqmbewsvp.supabase.co';//URL cliente SupaBase
const keySBsolver = //CLAVE cliente SupaBasse
...
const solverDB = supabase.createClient(urlSBsolver, keySBsolver); // Inicializa una instancia del cliente de SupaBase

// Función para obtener el usuario autenticado
const getUser = async () => { // Guarda en una constante llamada getUser una funcion asincrona para el uso de await en espera de una respuesta de API
  const {
    data: { user },
    error,
